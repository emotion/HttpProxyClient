...
import com.github.emotion.httpProxy.HttpResponseInterceptor;
...
public class DefaultHttpResponseInterceptor implements HttpResponseInterceptor {
    ...
    public void interpret(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, HttpResponse httpResponse, HttpURI targetUri) throws IOException {
    ...
    private void copyResponseHeaders(HttpResponse proxyResponse, HttpServletRequest servletRequest,
                                     HttpServletResponse servletResponse, HttpURI targetUri) {
    ...
    private void copyResponseHeader(HttpServletRequest servletRequest,
                                    HttpServletResponse servletResponse, Header header, HttpURI targetUri) {
...
//            IOUtils.copyLarge(entity.getContent(), servletResponse.getOutputStream());
     ...
     */
    private String rewriteUrlFromResponse(HttpServletRequest servletRequest, String theUrl, HttpURI targetUri) {
