...
import com.github.emotion.httpProxy.HttpUriRequestBuilder;
 ...
 */
public class DefaultHttpUriRequestBuilder implements HttpUriRequestBuilder {
    ...
    public HttpUriRequest interpret(HttpServletRequest httpServletRequest, HttpURI targetURI) throws IOException {
        // Make the Request
     ...
     */
    private String rewriteUrlFromRequest(HttpServletRequest servletRequest, HttpURI targetURI) {
     ...
     */
    private List<Header> copyRequestHeaders(HttpServletRequest servletRequest, HttpURI targetURI) {
     ...
     */
    private BasicHeader copyRequestHeader(HttpServletRequest servletRequest, String headerName, HttpURI targetURI) {
    ...
    private String getTargetUri(HttpServletRequest servletRequest, HttpURI targetURI) {
        return targetURI.getHttpURIString();
    }

    private HttpHost getTargetHost(HttpServletRequest servletRequest, HttpURI targetURI) {
